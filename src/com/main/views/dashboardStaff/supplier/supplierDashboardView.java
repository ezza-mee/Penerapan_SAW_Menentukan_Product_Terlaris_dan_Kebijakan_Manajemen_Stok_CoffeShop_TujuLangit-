...
public class supplierDashboardView extends contentPanel implements searchableView {
    ...
    public supplierDashboardView(mainFrame parentApp, dashboardStaffView parentView) {
        super();
    ...
    private void resetLinkLabel() {
        ...
        outStockSupplierLabel.setForeground(color.DARKGREY);
    ...
    private void setHeaderTableAllDataSupplier() {
        ...
        dataSupplierTable.getColumnModel().getColumn(1).setMinWidth(0);
        dataSupplierTable.getColumnModel().getColumn(1).setMaxWidth(0);
        dataSupplierTable.getColumnModel().getColumn(1).setWidth(0);
        ...
        dataSupplierTable.getColumnModel().getColumn(6).setMinWidth(0);
        dataSupplierTable.getColumnModel().getColumn(6).setMaxWidth(0);
        dataSupplierTable.getColumnModel().getColumn(6).setWidth(0);
    }
