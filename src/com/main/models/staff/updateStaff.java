...
public class updateStaff {
    public static boolean updateData(int idStaff, String nameStaff, String email, String phoneNumber, String gender,
            String jobdesk, String address) {
        String query = "UPDATE tbl_data_staff SET date = NOW(), name = ?, email = ?, phoneNumber = ?, gender = ?, jobdesk = ?, address = ?, status =  'Inactive' WHERE idStaff = ?";
