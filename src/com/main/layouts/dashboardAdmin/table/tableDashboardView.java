package com.main.layouts.dashboardAdmin.table;
...
import com.main.models.dataTable.loadDataTable;
                    ...
                    messagePopUp.getButtonConfrim().addActionListener(new java.awt.event.ActionListener() {
                        ...
                        public void actionPerformed(java.awt.event.ActionEvent ae) {
                            ...
                            if (selectedRow != -1) {
                                ...
                                getterDataTable selectedData = loadDataTable.getDataById(idTable);
